...
export function Feedback() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setStatus("success")
      setStatusMessage(
        "Got it. I read every note—thank you for trusting me with it."
      )
      form.reset()
    } catch {
      setStatus("error")
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-4 flex items-start gap-4">
              ...
              <div>
                <h2
                  id="feedback-heading"
                  className="font-heading text-3xl font-extrabold tracking-tight text-pretty text-foreground md:text-4xl"
                >
                  Put me to work. Tell me what you need.
                </h2>
                <p className="mt-4 text-base leading-relaxed text-muted-foreground md:text-lg">
                  Earlier, when I said a representative&apos;s only job is to
                  ask what you need and then go figure out how to make it
                  happen. I meant it. Whether it&apos;s a frustrating campus
                  policy, a club funding issue, or just something that makes the
                  daily hustle harder than it needs to be, drop it here. You can
                  always come back to this page to speak your mind.
                </p>
                <ShareThisPage className="mt-6 h-12 gap-2 border-primary/40 font-semibold text-foreground hover:bg-primary/10" />
              </div>
            </div>
          </div>
        </div>
